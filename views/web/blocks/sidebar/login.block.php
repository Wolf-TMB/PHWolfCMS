<div class="registrationForm mb-5 mt-5 border-start">
    <form>
        <div class="mb-3">
        ...
        <div class="text-center">
            ...
            <button type="submit" class="btn btn-primary" style="height: 2rem; width: 100%; background: white; color: black; padding: 0; border-radius: 15px; border-color: #302b63">Регистрация</button>
        </div>
    </form>
</div>