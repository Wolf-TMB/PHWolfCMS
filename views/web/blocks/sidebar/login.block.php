<div class="registrationForm mb-5 mt-5 border-start" style="height: 15vh">
<!--    <form>-->
<!--        <div class="mb-3">-->
...
<!--            <a href="/registration" class="btn btn-primary" style="height: 2rem; width: 100%; background: white; color: black; padding: 0; border-radius: 15px; border-color: #302b63">Регистрация</a>-->
<!--        </div>-->
<!--    </form>-->

    <div class="d-flex flex-row justify-content-sm-evenly h-100">
        <span class="my-auto">
